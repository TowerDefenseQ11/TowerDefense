...
public enum WaveTypes {
    ...
    WAVE_3("Welle 3", new EnemySpawningGroup[]{new EnemySpawningGroup(EnemyType.ENEMY_2, 10)}),
    WAVE_4("Welle 4", new EnemySpawningGroup[]{new EnemySpawningGroup(EnemyType.ENEMY_1, 30)}),
    WAVE_5("Welle 5", new EnemySpawningGroup[]{new EnemySpawningGroup(EnemyType.ENEMY_2, 30)}),
    WAVE_6("Welle 6", new EnemySpawningGroup[]{new EnemySpawningGroup(EnemyType.ENEMY_1, 30)});
